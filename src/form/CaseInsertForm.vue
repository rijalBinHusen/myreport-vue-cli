<template>
    <div class="w3-row">
        ...
        <div class="w3-col s6 w3-padding-large" style="overflow: auto; height: 400px;">
            ...
            <textarea v-model="masalah" rows="6" id="masalah" style="width:100%;"></textarea>
...
import { addCase, updateCase, getCaseId } from "@/composable/components/Cases"
...
export default {
    ...
    created() {
        ...
        // get the base record
        let base = getCaseId(obj?.id || obj?.parent)
        if(obj?.edit) {
