<template>
    ...
    <table class="htCore">
      <colgroup>
        <col  v-for="col in totalCol" :key="col" style="width: 100px">
      </colgroup>

      <thead>
        <tr>
          <th v-for="(col, index) in totalCol" :key="col">
            <div class="relative">
              <span :id="index" class="colHeader">{{ col }}</span>
            </div>
          </th>
        </tr>
      </thead>
      ...
      <tbody>
        <tr v-for="(row, index) in totalRow" :key="row" >
          <td v-for="(col, index2) in totalCol" :key="col" class="">
              <input :id="index2 + index" type="text">
            </td>
        </tr>  
      </tbody>
    </table>
